                    ...
                    <div className="absolute inset-0 p-12 flex flex-col justify-end max-w-3xl relative z-10">
                        ...
                        <div className="flex items-center gap-6">
                            {ctaState === 'NOT_STARTED' && (
                                <button className="flex items-center gap-3 bg-brand-orange text-white px-8 py-4 rounded-full font-bold uppercase tracking-wider hover:bg-brand-orange/90 hover:scale-105 transition-all shadow-[0_0_20px_rgba(255,147,0,0.4)]">
                                    <Play size={20} fill="currentColor" /> Start Course
                                </button>
                            )}
                            {ctaState === 'IN_PROGRESS' && (
                                <button className="flex items-center gap-3 bg-brand-blue-light text-brand-black px-8 py-4 rounded-full font-bold uppercase tracking-wider hover:bg-white hover:scale-105 transition-all shadow-[0_0_20px_rgba(120,192,240,0.4)]">
                                    <Play size={20} fill="currentColor" /> Resume Learning
                                </button>
                            )}
                            {ctaState === 'COMPLETED' && (
                                <button className="flex items-center gap-3 bg-green-500 text-black px-8 py-4 rounded-full font-bold uppercase tracking-wider hover:bg-green-400 hover:scale-105 transition-all shadow-[0_0_20px_rgba(34,197,94,0.4)]">

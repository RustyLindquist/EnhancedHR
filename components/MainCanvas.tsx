...
import { COURSE_CATEGORIES, COLLECTION_NAV_ITEMS, generateMockSyllabus, generateMockResources } from '../constants'; // Import generator
...
const MainCanvas: React.FC<MainCanvasProps> = ({ 
  ...
  const handleCourseClick = (courseId: number) => {
      const syllabus = generateMockSyllabus(courseId);
  ...
  // If a course is selected, we replace the grid view with the Course Page
  if (selectedCourseId) {
                    ...
                    {COURSE_CATEGORIES.map((cat, i) => (
                        <button
                            ...
                            className="
                                ...
                                hover:bg-white/10 hover:border-brand-blue-light/50 hover:text-white hover:shadow-[0_0_15px_rgba(120,192,240,0.2)]

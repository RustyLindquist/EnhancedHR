                        ...
                        {(view === 'login' || view === 'signup') && (
                            <div className="space-y-3 mb-6">
                                ...
                                <button
                                    ...
                                    className="w-full py-3 px-4 rounded-lg bg-white hover:bg-gray-100 text-gray-800 font-medium text-sm flex items-center justify-center gap-3 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {oauthLoading === 'google' ? (
                                ...
                                <button
                                    ...
                                    disabled={oauthLoading !== null}
                                    className="w-full py-3 px-4 rounded-lg bg-black hover:bg-gray-900 text-white font-medium text-sm flex items-center justify-center gap-3 border border-white/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {oauthLoading === 'apple' ? (
                                        <Loader2 size={18} className="animate-spin" />
                                    ) : (
                                ...
                                <div className="relative flex items-center py-2">
                                    ...
                                    <span className="flex-shrink mx-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Or continue with email</span>
                                    <div className="flex-grow border-t border-white/10"></div>
                                </div>
                            </div>
                        )}

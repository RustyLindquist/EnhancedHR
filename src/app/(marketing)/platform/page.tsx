...
export const metadata: Metadata = {
    title: 'AI Platform — EnhancedHR.ai',
    description: 'AI woven into every layer of learning. Course assistants, tutors, analytics, and intelligent content organization built for HR professionals.',
};
        ...
        <div className="overflow-hidden">
            ...
            <section className="relative bg-[#0A0D12]">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 pt-[200px] pb-[160px]">
                    ...
                    <FadeIn delay={200}>
                        <div className="flex flex-wrap justify-center gap-2 max-w-4xl mx-auto mt-[82px]">

...
export const metadata: Metadata = {
    title: 'For Experts — EnhancedHR.ai',
    description: 'Build and monetize HR courses on a legendary platform. Earn revenue, reach thousands of HR professionals, and grow your brand.',
};

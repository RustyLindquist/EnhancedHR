...
// Custom Description Panel for Org Courses (only shows draft/published status options)
function OrgCourseDescriptionPanel({
    ...
    }, [isOpen, currentTitle, currentDescription, currentCategory, currentStatus]);
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-amber-500/50 transition-colors"
                            placeholder="e.g., Leadership, Compliance, HR Fundamentals"
                        />
                    </div>

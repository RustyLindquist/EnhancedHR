...
import {
    ...
    FolderOpen, Bot, Target, Zap, Gamepad2,
...
export const metadata: Metadata = {
    title: 'Features — EnhancedHR.ai | AI-Native Knowledge Platform for HR',
    description: 'Expert-led courses, 5 AI agents, knowledge collections, and automatic SHRM & HRCI recertification. The complete AI-native platform for HR leaders.',
};
        ...
        <div className="overflow-hidden">
                    ...
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <FadeIn delay={150}>
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#4B8BB3]/10 border border-[#4B8BB3]/20 text-xs font-medium text-[#4B8BB3] tracking-wide mb-8">
                                <Sparkles size={12} /> 5 AI Agents &middot; SHRM &amp; HRCI Approved
                            </div>
                        </FadeIn>

                        {/* Headline — outcome-oriented, not just category label */}
                        <FadeIn delay={200}>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <FadeIn className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
                            You&apos;re navigating AI transformation, workforce upskilling, and compliance complexity — with tools designed for a simpler era.
                        </p>
                    </FadeIn>
                        ...
                        {[
                            {
                                ...
                                detail: 'Built for compliance checkboxes, not for developing strategic HR capabilities in the age of AI.',
                                icon: <BookOpen size={20} />,
                                color: '#FF9300',
                            },
                            {
                                problem: 'AI without context',
                                detail: 'ChatGPT doesn\'t know your courses, your policies, or your organization. Unscoped AI gives ungrounded answers.',
                                icon: <Brain size={20} />,
                                color: '#FF2600',
                            },
                            {
                                problem: 'Knowledge scattered everywhere',
                                detail: 'Training in one tool, policies in another, notes in a third. Your team wastes hours searching instead of learning.',
                    ...
                    <FadeIn delay={400} className="text-center mt-12">
                        <p className="text-xl text-slate-300 font-medium">
                            You need a platform that was born in the AI era — not retrofitted for it.
                        </p>
                    </FadeIn>
                </div>
            </section>
            ...
            <section className="py-28 bg-[#0B1120]/40 relative">
                <div className="max-w-7xl mx-auto px-6">
                    <FadeIn className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
                            Six integrated pillars that cover the full lifecycle of learning, knowledge management, and professional growth for HR teams.
                        </p>
                    </FadeIn>
                        ...
                        {[
                            {
                                ...
                                title: 'Academy',
                                desc: 'Expert-led courses designed for modern HR realities. Video modules, interactive quizzes, and downloadable resources from industry leaders who have done the work.',
                                color: '#4B8BB3',
                            },
                            {
                                icon: <Brain size={22} />,
                                title: 'AI Intelligence',
                                desc: 'Five specialized AI agents woven into every layer of the platform. Not a chatbot add-on — intelligence that understands your courses, your collections, and your role.',
                                color: '#78C0F0',
                            },
                            {
                                icon: <FolderOpen size={22} />,
                                title: 'Collections',
                                desc: 'AI-powered knowledge workspaces where you combine courses, notes, files, and videos into a single context. Then ask your Collection Assistant anything.',
                                color: '#FF9300',
                            },
                            {
                                icon: <Building2 size={22} />,
                                title: 'Organizations',
                                desc: 'Custom groups, org-specific courses, centralized knowledge bases, and analytics. Deploy learning across your team with the controls you actually need.',
                                color: '#4B8BB3',
                            },
                            {
                                icon: <Wrench size={22} />,
                                title: 'AI Tools',
                                desc: 'Purpose-built tools for HR: RolePlay Dojo for difficult conversations, Disruption Forecasting for AI impact, Skills Gap Analysis for workforce planning.',
                                color: '#FF2600',
                            },
                            {
                                icon: <Award size={22} />,
                                title: 'Recertification',
                                desc: 'Automatic SHRM PDC and HRCI credit tracking from the moment you start watching. Audit-proof certificates generated instantly upon completion.',
                                color: '#FF9300',
                            },
                        ].map((pillar, i) => (
                            <FadeIn key={i} delay={i * 80}>
                                <div className="p-7 rounded-2xl bg-white/[0.02] border border-white/[0.06] hover:bg-white/[0.04] hover:border-white/[0.1] transition-all duration-300 h-full">
                                    <div
                                        className="w-11 h-11 rounded-xl flex items-center justify-center mb-5"
                        ...
                        <div>
                            <FadeIn>
                                ...
                                <p className="text-base text-slate-500 mb-10 leading-relaxed">
                                    Every agent is grounded in the actual content on the platform. No hallucinations. No generic answers. Just context-aware intelligence that knows your courses, your collections, and your organization.
                                </p>
                            </FadeIn>
                            ...
                            <div className="space-y-5">
                                {[
                                    ...
                                    { name: 'Course Tutor', desc: 'Socratic coaching that adapts to your role, experience level, and goals.', icon: <GraduationCap size={16} />, color: '#FF9300' },
                        ...
                        <div>
                            <FadeIn>
                                ...
                                <p className="text-lg text-slate-400 mb-8 leading-relaxed">
                                    Collections are portable, AI-powered knowledge bases. Add courses, notes, files, videos — anything relevant to your project. Then let the Collection Assistant synthesize it all into actionable strategy.
                                </p>
                            </FadeIn>
                            ...
                            <FadeIn delay={250}>
                                <p className="text-sm text-slate-500 leading-relaxed">
                                    Your handbook becomes a live assistant. Your courses become searchable knowledge. Your notes, files, and research combine into a single AI brain that helps you build — not just learn.
                                </p>
                            </FadeIn>
                        </div>
                    </div>
            ...
            <section className="py-28 relative">
                <div className="max-w-7xl mx-auto px-6">
                    <FadeIn className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
                            Enterprise-grade capabilities without the enterprise-grade complexity. Deploy AI-enhanced learning across your entire organization in minutes, not months.
                        </p>
                    </FadeIn>
                        ...
                        {[
                            {
                                icon: <Users size={22} />,
                                title: 'Custom Groups',
                                desc: 'Create unlimited employee segments by team, department, onboarding cohort, or custom criteria. Assign required or recommended content to each group. Dynamic groups auto-segment as roles change.',
                                color: '#4B8BB3',
                            },
                            {
                                icon: <BookOpen size={22} />,
                                title: 'Org Courses',
                                desc: 'Build and host your own courses on the same AI-enhanced platform. Upload existing video content or create from scratch. Your internal training gets the same AI agents as Academy courses.',
                                color: '#78C0F0',
                            },
                            {
                                icon: <FolderOpen size={22} />,
                                title: 'Org Collections',
                                desc: 'Centralized knowledge bases for your company. Employee handbooks, policies, procedures, org-specific resources. The AI learns it all, so employee questions get org-specific answers.',
                                color: '#FF9300',
                            },
                        ].map((feature, i) => (
                            <FadeIn key={i} delay={i * 100}>
                    ...
                    {/* Additional org features row */}
                    <FadeIn delay={400} className="mt-8">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {[
                                { icon: <BarChart3 size={16} />, label: 'Analytics Dashboard' },
                                { icon: <Target size={16} />, label: 'Required Assignments' },
                                { icon: <TrendingUp size={16} />, label: 'Engagement Tracking' },
                                { icon: <Shield size={16} />, label: 'Admin Controls' },
                            ].map((item, i) => (
                                <div key={i} className="flex items-center gap-3 p-4 rounded-xl bg-white/[0.02] border border-white/[0.06]">
                                    <div className="text-[#4B8BB3]">{item.icon}</div>
            ...
            <section className="py-16 relative">
                <div className="max-w-3xl mx-auto px-6 text-center">
                    <FadeIn>
                        <p className="text-lg text-slate-400 mb-8">
                            Deploy AI-enhanced learning across your team today.
                        </p>
                        <LandingCTA />
                    </FadeIn>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-1 lg:order-2">
                        <FadeIn>
                            ...
                            <p className="text-lg text-slate-400 mb-8 leading-relaxed">
                                Never manually track a credit again. EnhancedHR.ai is an approved provider for both SHRM and HRCI. Credits are calculated automatically based on your exact watch time — down to the minute.
                            </p>
                        </FadeIn>
                        ...
                        <FadeIn delay={150}>
                            <ul className="space-y-4 mb-8">
                                {[
                                    { text: 'Automatic SHRM PDC and HRCI credit calculation', icon: <RefreshCw size={11} /> },
                                    { text: 'Instant certificate generation the moment you finish', icon: <FileText size={11} /> },
                                    { text: 'Audit-proof ledger of your entire learning history', icon: <Shield size={11} /> },
                                    { text: 'Multi-session tracking — pick up exactly where you left off', icon: <Clock size={11} /> },
                                ].map((item, i) => (
                        ...
                        <FadeIn delay={250}>
                            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.06]">
                                <p className="text-sm text-slate-400 leading-relaxed">
                                    <span className="text-white font-semibold">For organizations:</span> Track recertification progress across your entire team. See who is on track, who needs a nudge, and generate compliance reports in one click.
                                </p>
                            </div>
                        </FadeIn>
                    </div>
            ...
            <section className="py-28 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative">
                    <FadeIn className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
                            Whether you&apos;re an individual growing your career or a CHRO empowering your entire team, we keep it straightforward.
                        </p>
                    </FadeIn>
                            ...
                            <div className="p-8 rounded-2xl bg-white/[0.02] border border-white/[0.06] h-full flex flex-col">
                                ...
                                <ul className="space-y-3 flex-1 mb-8">
                                    {[
                                        ...
                                        'New expert-led content added regularly',
                                    ].map((item, i) => (
                    ...
                    <FadeIn delay={300} className="text-center mt-8">
                        <p className="text-sm text-slate-500 mb-6">7-day free trial on all plans. No credit card required. Cancel anytime.</p>
                    </FadeIn>
                    ...
                    <FadeIn delay={400} className="mt-16">
                        <div className="text-center max-w-3xl mx-auto">
                            ...
                            <p className="text-lg text-slate-400 mb-10 max-w-xl mx-auto leading-relaxed">
                                Join the HR leaders who are using AI-native tools to learn faster, make better decisions, and stay ahead of the curve.
                            </p>

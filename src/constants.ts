...
// MOCK_INSTRUCTORS removed - now using real data from database via getExpertsWithPublishedCourses()
...
export const MAIN_NAV_ITEMS: NavItemConfig[] = [
  ...
  { id: 'my-org', label: 'My Organization', icon: Building },
...
export const EXPERT_NAV_ITEMS: NavItemConfig[] = [
    ...
    { id: 'author/proposals', label: 'Course Proposals', icon: FileText },

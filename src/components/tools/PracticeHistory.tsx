        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] text-center">
                ...
                <p className="text-slate-400 text-sm max-w-md leading-relaxed">
                    Your roleplay practice sessions will appear here.
                    Start a new session to practice difficult workplace conversations.
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h3 className="text-lg font-semibold text-white">Your Practice History</h3>
            ...
            <DeleteConfirmationModal
                ...
                itemTitle={conversationToDelete?.title || 'Practice Session'}
                description="This will permanently delete this practice session and all associated data. This action cannot be undone."

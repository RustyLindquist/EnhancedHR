                            ...
                            <>
                                ...
                                <div className="mb-12">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        {/* All Users List Item - Always First */}
                                        <AllUsersListItem onClick={onSelectAllUsers} memberCount={totalMembers} />

                                        {/* Regular Group List Items */}
                                        {regularGroups.map((group, index) => (
                                            <div key={group.id} style={{ animationDelay: `${(index + 1) * 30}ms` }}>
                                                <GroupListItem
                                                    group={group}
                                                    onClick={() => onSelectGroup(group.id)}
                                                    isDynamic={false}
                                        ...
                                        {/* Empty State - shown when no regular groups exist */}
                                        {regularGroups.length === 0 && groups.length === 0 && (
                                            <div className="bg-[#131b2c]/50 border border-dashed border-white/10 rounded-xl p-8 flex flex-col items-center justify-center">
                                                <Layers size={32} className="text-slate-600 mb-3" />
                                                <h3 className="text-white font-semibold mb-2">No Groups Yet</h3>
                                                <p className="text-slate-500 text-xs text-center max-w-[200px] mb-4">
                                                    Create groups to organize your team
                                    ...
                                    <div className="mb-12">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            {dynamicGroups.map((group, index) => (
                                                <div key={group.id} style={{ animationDelay: `${index * 30}ms` }}>
                                                    <GroupListItem
                                                        group={group}
                                                        onClick={() => onSelectGroup(group.id)}
                                                        isDynamic={true}
                        ...
                        {viewMode === 'grid' ? (
                            ...
                            <>
                                ...
                                <div className="mb-12">
                                    <h2 className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-6">Organization</h2>
                                    <div className="flex flex-col gap-2">
                                        <AllUsersListItem onClick={onSelectAllUsers} memberCount={0} />
                                    </div>
                                </div>
                                ...
                                {memberCustomGroups.length > 0 && (
                                    <div className="mb-12">
                                        <h2 className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-6">My Groups</h2>
                                        <div className="flex flex-col gap-2">
                                            {memberCustomGroups.map((group, index) => (
                                                <div key={group.id} style={{ animationDelay: `${index * 30}ms` }}>
                                                    <GroupListItem
                                                        group={group}
                                                        onClick={() => onSelectGroup(group.id)}
                                ...
                                {memberDynamicGroups.length > 0 && (
                                    <div className="mb-12">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            {memberDynamicGroups.map((group, index) => (
                                                <div key={group.id} style={{ animationDelay: `${index * 30}ms` }}>
                                                    <GroupListItem
                                                        group={group}
                                                        onClick={() => onSelectGroup(group.id)}
                                ...
                                {!hasMemberGroups && (
                                    <div className="mb-12">
                                        <h2 className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-6">My Groups</h2>
                                        <div className="bg-[#131b2c]/50 border border-dashed border-white/10 rounded-xl p-12 flex flex-col items-center justify-center">
                                            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center mb-4 border border-white/10">
                                                <Users size={28} className="text-slate-500" />
                                            </div>
                                            <h3 className="text-white font-semibold text-lg mb-2">Not in Any Groups Yet</h3>

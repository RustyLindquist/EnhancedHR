    ...
    return (
        <>
            ...
            >
                        ...
                        {itemType !== 'PROFILE' && (
                            <div>
                                ...
                                <input
                                    ...
                                    disabled={itemType === 'AI_INSIGHT'} // Insights keep their source title
                ...
                {/* Footer Actions */}
                <div className="p-6 border-t border-white/10 flex justify-end bg-black/20 flex-shrink-0">
                    <button
                        onClick={handleSave}
                        disabled={isSaving}
                        className="
                            flex items-center gap-2 px-8 py-3 rounded-lg font-bold text-sm uppercase tracking-wide
